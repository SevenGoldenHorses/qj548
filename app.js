...
var fs = require('fs')
var logger = fs.createWriteStream('report_Castello.txt', {
...
function BOMBA(tweet) {
	...
	if ( tweet.user.screen_name !== 'castellodocet' ) {
